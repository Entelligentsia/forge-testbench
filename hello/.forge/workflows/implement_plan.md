...
effort: medium
mode: stub
workflow_id: implement_plan
---

# Workflow: implement_plan (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=implement_plan`.
2. After lazy-materialize completes, re-read `.forge/workflows/implement_plan.md` (it
