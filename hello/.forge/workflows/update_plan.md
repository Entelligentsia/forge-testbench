...
effort: medium
mode: stub
workflow_id: update_plan
---

# Workflow: update_plan (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=update_plan`.
2. After lazy-materialize completes, re-read `.forge/workflows/update_plan.md` (it
