...
effort: medium
mode: stub
workflow_id: architect_review_sprint_completion
---

# Workflow: architect_review_sprint_completion (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=architect_review_sprint_completion`.
2. After lazy-materialize completes, re-read `.forge/workflows/architect_review_sprint_completion.md` (it
