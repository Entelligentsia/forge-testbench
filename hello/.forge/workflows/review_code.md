...
effort: medium
mode: stub
workflow_id: review_code
---

# Workflow: review_code (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=review_code`.
2. After lazy-materialize completes, re-read `.forge/workflows/review_code.md` (it
