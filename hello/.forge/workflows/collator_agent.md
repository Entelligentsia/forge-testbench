...
effort: medium
mode: stub
workflow_id: collator_agent
---

# Workflow: collator_agent (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=collator_agent`.
2. After lazy-materialize completes, re-read `.forge/workflows/collator_agent.md` (it
