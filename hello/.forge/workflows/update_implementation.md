...
effort: medium
mode: stub
workflow_id: update_implementation
---

# Workflow: update_implementation (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=update_implementation`.
2. After lazy-materialize completes, re-read `.forge/workflows/update_implementation.md` (it
