...
effort: medium
mode: stub
workflow_id: architect_sprint_plan
---

# Workflow: architect_sprint_plan (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=architect_sprint_plan`.
2. After lazy-materialize completes, re-read `.forge/workflows/architect_sprint_plan.md` (it
