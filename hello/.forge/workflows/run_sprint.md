...
effort: medium
mode: stub
workflow_id: run_sprint
---

# Workflow: run_sprint (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=run_sprint`.
2. After lazy-materialize completes, re-read `.forge/workflows/run_sprint.md` (it
