...
effort: medium
mode: stub
workflow_id: commit_task
---

# Workflow: commit_task (fast-mode stub)
...
1. Read `${CLAUDE_PLUGIN_ROOT}/init/generation/lazy-materialize.md` and
   follow it exactly, with `workflow_id=commit_task`.
2. After lazy-materialize completes, re-read `.forge/workflows/commit_task.md` (it
