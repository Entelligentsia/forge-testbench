...
Each project is self-contained with its own build system, dependencies, and tests. See the `AGENTS.md` inside each subdirectory for project-specific guidance.
